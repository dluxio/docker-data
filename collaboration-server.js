...
// Test API endpoint for collaboration authentication
server.router.get('/api/test-auth', async (request, reply) => {
  try {
    // Extract auth headers
    const account = request.headers['x-account']
    const challenge = request.headers['x-challenge']
