const BlockchainMonitoringService = require('./blockchain-monitor');
...
describe('BlockchainMonitoringService', () => {
    ...
    beforeEach(() => {
        ...
        service = new (require('./blockchain-monitor').constructor)();
    ...
    describe('Configuration Validation', () => {
        test('should validate required API keys', () => {
            expect(() => {
                new (require('./blockchain-monitor').constructor)();
            }).not.toThrow();
        });
